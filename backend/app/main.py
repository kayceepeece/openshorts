"""FastAPI application entrypoint: routes, job queue, and the wire-up of every backend feature."""
import os
import uuid
import subprocess
import threading
...
from app.overlays.hooks import add_hook_to_video
from app.integrations.elevenlabs import translate_video, get_supported_languages
from app.thumbnails.titles import analyze_video_for_titles, refine_titles
from app.thumbnails.images import generate_thumbnail
from app.thumbnails.descriptions import generate_youtube_description
    ...
    async def run_background_whisper():
        try:
            ...
            if not vpath and url:
                from app.ingest.youtube import download_youtube_video
                loop = asyncio.get_event_loop()
